<?php
 ...
 if(isset($_SESSION['un'])&&$_SESSION['un']!= ''&&$_SESSION['rl']=='Admin'){
	...
	$sql = "SELECT * FROM users WHERE activated = 'false' ORDER BY name ASC ";
		  		...
		  		<div class="row">
		  				<div class="col-md-12">
		  					<div class="content-box-header">
			  					<div class="panel-title">List of Unactivated Users</div>
									...
									<div class="message"><?php if(isset($message)) { echo $message; } ?></div>
										...
										?>
											<tr>
												...
												<td><a href="php/activate_user.php?user=<?php echo $row["username"]; ?>" class="btn-sm btn-primary">ACTIVATE USERS</a> </td>
											</tr>
										<?php
										// $i++;
										}
